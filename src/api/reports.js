...
// 集团
const getEnterpriseReportList = ({startTime, endTime, price, pageNo, pageSize}) => getAction('/table/getAgentDetails', {startTime, endTime, price, pageNo, pageSize})
const getEnterpriseReportStatistic = (startTime, endTime) => getAction('/table/getAgentTotal', {startTime, endTime})

// 酒店
const getHotelReportList = ({hotelId, startTime, endTime, price, pageNo, pageSize}) => getAction('/table/getHotelDetails', {hotelId, startTime, endTime, price, pageNo, pageSize})
...
const getMineReportList = ({startTime, endTime, price, pageNo, pageSize}) => getAction('/table/getAgentDetails', {startTime, endTime, price, pageNo, pageSize})
