...
// 集团
const getEnterpriseReportList = ({startTime, endTime, column, order, pageNo, pageSize}) => getAction('/table/getAgentDetails', {startTime, endTime, column, order, pageNo, pageSize})
const getEnterpriseReportStatistic = (startTime, endTime) => getAction('/table/getAgentTotal', {startTime, endTime})

// 酒店
const getHotelReportList = ({hotelId, startTime, endTime, column, order, pageNo, pageSize}) => getAction('/table/getHotelDetails', {hotelId, startTime, endTime, column, order, pageNo, pageSize})
...
const getMineReportList = ({startTime, endTime, column, order, pageNo, pageSize}) => getAction('/table/getAgentDetails', {startTime, endTime, column, order, pageNo, pageSize})
